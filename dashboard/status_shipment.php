								...
								<form class="xform" id="admin_form" method="post">
									...
									<div class="row">
										<div class="col-sm-12 col-md-6">
											...
											<textarea class="form-control" placeholder="Status change details...." id="message-text" name="comments"></textarea>
										</div>
										...
										<div class="col-sm-12 col-md-3">
											<div class="form-group"> 
												...
												<input class="form-control" name="code_offnew" list="browsee" autocomplete="off" placeholder="--Select Office--">
												<datalist id="browsee">
										...
										<div class="col-sm-12 col-md-3">
											<label for="inputcontact" class="control-label col-form-label">Oficina</label>
											<div class="input-group mb-3">
												<input class="form-control" name="code_offnew" value="<?php echo $user->name_off; ?>" readonly>
											</div>
										</div>
										<?php } ?>
										...
										<div class="col-sm-12 col-md-3">
											...
											<div class="input-group mb-3">
												<input class="form-control" name="status_courier" placeholder="--Select Status--" list="browserst" autocomplete="off" required="required">
